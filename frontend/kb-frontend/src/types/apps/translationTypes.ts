...
export type LocalizationSyncPreview = { sourceArticleId: string; sourceLocaleCode: string; sourceVersionId: string; sourceVersionNumber: number; scope: LocalizationSyncScope; mode: LocalizationSyncMode; items: LocalizationSyncPreviewItem[] }
...
export type LocalizationSyncResult = { sourceArticleId: string; sourceVersionId: string; sourceVersionNumber: number; outcomes: LocalizationSyncOutcome[] }
