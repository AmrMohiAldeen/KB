...
// React Imports
import { isValidElement, forwardRef, useContext, useEffect, useState } from 'react'
...
const MenuItem: ForwardRefRenderFunction<HTMLLIElement, MenuItemProps> = (props, ref) => {
  ...
  useEffect(() => {
    const componentProps =
      component && typeof component !== 'string' && isValidElement(component)
        ? (component as ReactElement<ComponentWithHref>).props
        : undefined

    const href = rest.href || componentProps?.href
