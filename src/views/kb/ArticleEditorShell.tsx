...
import { CategoryTree, KbPageShell, PageHeader, StatusChip, articleStatusColor, roleLabels } from './KbShared'
import { emptyCategories } from './kbMockData'
import type { EditorArticleDraft } from './kbMockData'
...
const ArticleEditorShell = ({ lang }: { lang: string }) => {
  ...
  return (
    <KbPageShell maxWidth='100%'>
      ...
      <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', xl: '280px minmax(0, 1fr)' }, gap: 6, alignItems: 'start' }}>
        <Stack spacing={4}>
