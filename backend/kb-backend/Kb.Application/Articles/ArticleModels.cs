...
public sealed record ArticleListData(Guid Id, string Title, string Slug, string Status,
    ...
    UserReference? LockedBy, int Position, string Visibility = "Public", string? LegacyAuthorName = null,
    string? LegacyAuthorEmail = null, string? LegacyAuthorExternalId = null);
...
public sealed record ArticleData(Guid Id, string Title, string Slug, string Status, CategoryReference? Category,
    ...
    string Visibility = "Public", string? LegacyAuthorName = null, string? LegacyAuthorEmail = null,
    string? LegacyAuthorExternalId = null);
