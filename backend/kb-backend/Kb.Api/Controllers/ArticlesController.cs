...
public sealed class ArticlesController(ArticleService articles) : ControllerBase
{
    ...
    private static ArticleDetailsResponse ToDetailsResponse(ArticleData article) => new(article.Id,
        ...
        article.CurrentDraft is null ? null : new ArticleDraftMetadataResponse(article.CurrentDraft.Id,
            article.CurrentDraft.ContentJsonPath, article.CurrentDraft.RenderedHtmlPath,
            article.CurrentDraft.PlainTextPath, article.CurrentDraft.ContentHash, article.CurrentDraft.ContentSizeBytes,
        ...
        article.CurrentPublishedVersion is null ? null : new ArticlePublishedVersionMetadataResponse(
            ...
            article.CurrentPublishedVersion.ContentJsonPath, article.CurrentPublishedVersion.RenderedHtmlPath,
            article.CurrentPublishedVersion.PlainTextPath, article.CurrentPublishedVersion.ContentHash,
